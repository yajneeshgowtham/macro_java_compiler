...
public class GJDepthFirst<R,A> implements GJVisitor<R,A> {
   ...
   public IRTable Cons() {
	   IRTable a=new IRTable();
	   a.Name=null;
	   a.Parent=null;
	   a.methods=new Vector<String>();
	   a.Tables=new HashMap<String,IRTable>();
	   a.ret_val=null;
	   a.var_dec=new Vector<String>();
	  a.types=new HashMap<String,String>(); 
	   a.dec=new Vector<String>();
	   a.num_dec=0;
	   return a;
	   
   }
   HashMap<String,IRTable> GlobalTable;
   public R visit(Goal n, A argu) {
      R _ret=null;
      GlobalTable=new HashMap<String,IRTable>();
      argu=(A)GlobalTable;
   ...
   public R visit(MethodDeclaration n, A argu) {
      ...
      n.f4.accept(this, (A)vec);
      //System.out.println(vec);
      m.num_dec=vec.size();
      //System.out.println(m.num_dec);
      m.dec=vec;
      for(String str:vec) {
    	  m.var_dec.add(str);
      }
   ...
   public R visit(FormalParameter n, A argu) {
      ...
      Vector<String> vec=(Vector<String>)argu;
      vec.add((String)_ret);
      return _ret;
   }
   ...
   public R visit(FormalParameterRest n, A argu) {
     ...
     //System.out.println("FPRet "+ (String)_ret);
      return _ret;
   }
...
//      i++;
//      System.out.println("MOVE TEMP "+i+" TIMES TEMP "+(i-1)+" TEMP ")
      return _ret;
   }
